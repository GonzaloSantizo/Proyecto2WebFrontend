...
const SignIn = () => {
  ...
  return (
    <div className={styles}>
      ...
      />
      <br />
      {data == true || data == null ? null : (
        <Notification type="danger">{data}</Notification>
      )}
      {form.error ? (
        <Notification type="warning">
          El usuario o contraseña ingresado no cumplen con los requerimientos
          establecidos
        </Notification>
      ) : null}
      <br />
